# =============================================================================
# Production_FastAPI_AI_Service_Template.py
# =============================================================================
#
# PURPOSE
# This project is my primary AI engineering implementation project.
# It combines multiple concepts learned independently (Prompt Engineering,
# FastAPI, RAG, Vector Databases, LLM Routing, and Evaluation) into a
# single production-style API service.
#
# BUSINESS PROBLEM
# Recruiters and hiring managers spend significant time reviewing CVs,
# comparing candidates, and answering questions from internal knowledge
# bases. This service demonstrates how AI can automate and augment those
# workflows through structured APIs.
#
# CAPABILITIES
#   1. CV Analysis
#      - Analyse candidate resumes
#      - Generate strengths, concerns, confidence scores
#      - Produce tailored interview questions
#
#   2. Candidate Comparison
#      - Compare two candidates head-to-head
#      - Identify winner and key differentiators
#
...
# - Gemini 2.5 Flash is the default provider due to speed and cost efficiency.
# - OpenAI GPT-4.1-mini is the fallback provider for reliability.
# - ChromaDB is used for local persistent vector storage.
# - Pydantic v2 field validators enforce data quality at the API boundary.
# - Logging is preferred over print statements for observability.
# - Provider fallback is implemented to improve resilience.
#
